...
{
    public class FunctionInitializationWrapper : IFunctionInitializationWrapper
    {
        private readonly ILogger<FunctionInitializationWrapper> _logger;

        public FunctionInitializationWrapper(ILogger<FunctionInitializationWrapper> logger)
        {
            _logger = logger;
        }
                ...
                foreach (var initializerMethod in initializerMethods)
                {
                    ...
                    try
                    {
                        ...
                        await retryPolicy.ExecuteAsync(async () =>
                        {
                            ...
                            var createdFunctions = await tOut;
