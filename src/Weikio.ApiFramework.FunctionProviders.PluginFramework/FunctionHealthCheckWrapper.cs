...
namespace Weikio.ApiFramework.FunctionProviders.PluginFramework
{
    ...
    public class FunctionHealthCheckWrapper : IFunctionHealthCheckWrapper
    {
        private readonly ILogger<FunctionHealthCheckWrapper> _logger;

        public FunctionHealthCheckWrapper(ILogger<FunctionHealthCheckWrapper> logger)
        {
            _logger = logger;
        }
