...
namespace Weikio.ApiFramework.ApiProviders.PluginFramework
{
    ...
    // This breaks the ability to pass in ILogger.
    // Also not sure if we should support multiple health checks & health check methods (meaning health check which don't depend on Microsoft.Extensions.Diagnostics.HealthChecks.Abstractions
